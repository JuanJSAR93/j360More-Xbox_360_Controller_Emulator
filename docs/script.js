...
const translations = {
  es: {
    ...
    f9_title: "AirPad: Mando Móvil Táctil",
    f9_desc: "Transforma cualquier smartphone en un mando virtual con conexión instantánea por código QR, respuesta inmediata por WebSockets, modo HTTPS para mantener la pantalla siempre encendida y personalización total de botones y joysticks.",
    dual_tag: "Soporte Multi-Consola",
    dual_title: "Emulación de Xbox 360, Xbox One, PS4, PS5 y Switch 2 Pro",
    dual_subtitle: "j360More te permite elegir qué tipo de mando crear en tu sistema mediante los drivers VIIPER y ViGEmBus: Xbox 360, Xbox One (GIP), DualShock 4, DualSense (PS5), Nintendo Switch 2 Pro o modo Mixto simultáneo.",
    ...
    dual_xboxone_badge: "GIP / XInput",
    dual_xboxone_count: "1 a 12 Mandos",
    dual_xboxone_title: "Mando Xbox One (GIP/XInput)",
    dual_xboxone_desc: "Emulación oficial mediante el protocolo Microsoft GIP vía VIIPER. Windows PnP lo reconoce nativamente como mando Xbox One con compatibilidad total XInput.",
    dual_ds4_badge: "DirectInput",
    ...
    dual_dualsense_badge: "DirectInput",
    ...
    driver_viiper_desc: "Potente servidor de emulación USB sobre red local (USB/IP) que permite crear mandos virtuales de última generación directamente en Windows y Linux (Beta). El ejecutable ya viene incluido en j360More.",
    driver_viiper_why_title: "¿Para qué se utiliza en j360More?",
    driver_viiper_why_desc: "Es el nuevo motor de emulación predeterminado y multiplataforma. Permite generar mandos de Xbox 360, Xbox One (GIP/XInput), DualShock 4, DualSense (PS5) y Nintendo Switch 2 Pro. En Windows requiere el controlador complementario usbip-win2.",
    driver_viiper_b1: "Emulación de 5 familias de mandos: Xbox 360, Xbox One (GIP), PS4, PS5 y Switch 2 Pro.",
    driver_viiper_b2: "Arquitectura estándar USB/IP: soporte para Windows y Linux (Beta).",
    ...
    req_row_os_val: "Windows 11 / Linux (Beta)",
    req_row_drivers: "Driver de Emulación",
    req_row_drivers_val1: "VIIPER (con usbip-win2) o ViGEmBus",
    req_row_drivers_val2: "VIIPER (Multiplataforma: X360, Xbox One, DS4, PS5, Switch 2)",
    ...
    faq_q5: "¿Cómo funciona AirPad para usar mi celular como mando?",
    faq_a5: "Solo activa el servidor en la pestaña 'AirPad' de j360More y escanea el código QR desde la cámara de tu smartphone conectado a la misma red WiFi. No necesitas instalar ninguna app; el mando se ejecuta directamente en el navegador. Puedes activar el modo HTTPS para mantener la pantalla siempre encendida (Wake Lock) y personalizar libremente la ubicación de los botones y palancas.",
  ...
  en: {
    ...
    f9_title: "AirPad: Mobile Touch Gamepad",
    f9_desc: "Transform any smartphone into a virtual gamepad with instant QR code pairing, low-latency WebSockets, HTTPS mode to keep the screen awake, and full on-screen button repositioning.",
    dual_tag: "Multi-Console Support",
    dual_title: "Xbox 360, Xbox One, PS4, PS5 & Switch 2 Pro Emulation",
    dual_subtitle: "j360More allows you to choose what type of controller to spawn on your system using VIIPER and ViGEmBus: Xbox 360, Xbox One (GIP), DualShock 4, DualSense (PS5), Nintendo Switch 2 Pro, or simultaneous Mixed mode.",
    ...
    dual_xboxone_badge: "GIP / XInput",
    dual_xboxone_count: "1 to 12 Controllers",
    dual_xboxone_title: "Xbox One Controller (GIP/XInput)",
    dual_xboxone_desc: "Official emulation powered by Microsoft's General Input Protocol (GIP) via VIIPER. Windows PnP discovers it natively as an authentic Xbox One gamepad with full XInput support.",
    dual_ds4_badge: "DirectInput",
    ...
    driver_viiper_desc: "High-performance USB over IP (USB/IP) emulation server to spawn next-generation virtual gamepads on Windows and Linux (Beta). The standalone binary is bundled inside j360More.",
    driver_viiper_why_title: "Why is it used in j360More?",
    driver_viiper_why_desc: "It is the new default, cross-platform emulation engine. Spawns Xbox 360, Xbox One (GIP/XInput), DualShock 4, DualSense (PS5), and Nintendo Switch 2 Pro controllers. On Windows, it pairs with the companion usbip-win2 driver.",
    driver_viiper_b1: "Emulates 5 gamepad families: Xbox 360, Xbox One (GIP), PS4, PS5, and Switch 2 Pro.",
    driver_viiper_b2: "Standard USB/IP architecture: ready for Windows and Linux (Beta).",
    ...
    req_row_drivers_val2: "VIIPER (Multiplatform: X360, Xbox One, DS4, PS5, Switch 2)",
    ...
    faq_q5: "How does AirPad work to use my mobile phone as a controller?",
    faq_a5: "Just enable the server in j360More's 'AirPad' tab and scan the QR code using your phone's camera while connected to the same Wi-Fi network. No app installation needed; the controller runs directly in your browser. You can enable HTTPS mode to keep the screen awake (Screen Wake Lock) and freely customize on-screen button positions and sizes.",
