...
const translations = {
  es: {
    ...
    hero_subtitle: "Convierte cualquier control genérico USB, mando de PlayStation, palanca arcade o múltiples teclados independientes en mandos oficiales de Xbox 360 (XInput) con precisión milimétrica y compatibilidad total en PC.",
    ...
    dual_title: "Emulación Oficial de Xbox 360 y DualShock 4",
    dual_subtitle: "j360More te permite emular tanto mandos de Xbox 360 como de PlayStation 4, o combinar ambos en modo Mixto a través de ViGEmBus.",
    ...
    dual_mixed_badge: "Modo Mixto",
    dual_mixed_title: "Soporte Mixto: Xbox 360 + DualShock 4",
    dual_mixed_desc: "Configura de 2 a 12 mandos y j360More emulará automáticamente la mitad como Xbox 360 y la otra mitad como DualShock 4, permitiendo jugar en simultáneo con ambos tipos sin conflictos.",
    dual_chip_2: "🎮 2 Mandos (1 Xbox + 1 DS4)",
    dual_chip_4: "🎮 4 Mandos (2 Xbox + 2 DS4)",
    dual_chip_8: "🎮 8 Mandos (4 Xbox + 4 DS4)",
    dual_chip_12: "🎮 12 Mandos (6 Xbox + 6 DS4)",
    ...
    s3_desc: "Selección del tipo de mando (Xbox 360, DualShock 4 o Mixto), cantidad de mandos, idioma y control de HidHide.",
  ...
  en: {
    ...
    hero_subtitle: "Turn any generic USB controller, PlayStation gamepad, arcade stick, or multiple independent keyboards into official Xbox 360 controllers (XInput) with pinpoint accuracy and full PC compatibility.",
    ...
    dual_title: "Official Xbox 360 & DualShock 4 Emulation",
    dual_subtitle: "j360More lets you emulate both Xbox 360 and PlayStation 4 controllers, or combine both in Mixed mode via ViGEmBus.",
    ...
    dual_mixed_badge: "Mixed Mode",
    dual_mixed_title: "Mixed Mode: Xbox 360 + DualShock 4",
    dual_mixed_desc: "Configure from 2 to 12 controllers and j360More will automatically emulate half as Xbox 360 and half as DualShock 4, allowing simultaneous play with both types with zero conflicts.",
    dual_chip_2: "🎮 2 Gamepads (1 Xbox + 1 DS4)",
    dual_chip_4: "🎮 4 Gamepads (2 Xbox + 2 DS4)",
    dual_chip_8: "🎮 8 Gamepads (4 Xbox + 4 DS4)",
    dual_chip_12: "🎮 12 Gamepads (6 Xbox + 6 DS4)",
    ...
    s3_desc: "Selection of controller type (Xbox 360, DualShock 4, or Mixed), controller count, language, and HidHide control.",
